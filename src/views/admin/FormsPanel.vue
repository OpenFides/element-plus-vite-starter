...
body{background:#ffffff!important}.undrag{background:#ebecee!important}.from-panel{padding:50px 100px;min-width:500px;background:#ffffff;/deep/ .from-title {
  ...
  //height: 100vh;}.choose{background:#e9ebee}.form-group{margin:20px 0;padding:5px 0px;border-radius:10px;//border:1px solid #d3d3d3;box-shadow:1px 1px 10px 0 #d2d2d2;&:hover {
