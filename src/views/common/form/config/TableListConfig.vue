<template>
  <div>
    ...
    <el-form-item label="布局方式">
      <el-radio name="layout" :label="true" v-model="value.rowLayout"
        >按表格</el-radio
      >
      <el-radio name="layout" :label="false" v-model="value.rowLayout"
        >按表单</el-radio
      >
    </el-form-item>
