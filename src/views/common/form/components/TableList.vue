  ...
  <div>
    ...
    <div v-else>
      <div v-if="rowLayout">
        <el-table
          size="medium"
          :header-cell-style="{ background: '#f5f7fa', padding: '3px 0' }"
          :border="showBorder"
          :data="_value"
          style="width: 100%"
        >
          ...
          >
            <template v-slot="scope">
              <form-design-render
                ...
                v-model:value="_value[scope.$index][column.id]"
                :mode="mode"
                :config="column"
              />
            </template>
...
<script>
import { Close as ElIconClose, Plus as ElIconPlus } from '@element-plus/icons'
